 ...
 * Premium Signup Page for Digital Heroes.
 */
    ...
    <main className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        <div className="text-center">
          <h1 className="text-5xl font-black tracking-tighter text-white mb-2">JOIN THE SQUAD</h1>
          <p className="text-foreground/60 font-medium italic">Your journey to the leaderboard starts here.</p>
        </div>
        ...
        <div className="p-8 rounded-3xl glass border border-surface-border space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-foreground/40 ml-1">Create Password</label>
              <div className="relative">
        ...
        <p className="text-center text-sm font-medium text-foreground/60">
          Already a hero? <Link href="/login" className="text-primary font-bold hover:underline">Login here</Link>
        </p>
      </div>
    </main>
  );
